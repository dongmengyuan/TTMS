    ...
    <table class="table table-hover" id="stdio" onclick="find(this)">
        ...
        <c:forEach items="${list }" var="list">
            <tr>
                ...
                <c:if test="${list.head_path!=null}">
                    <td><img src="<%=basePath %>${list.head_path}" width=100 height=100 /></td>
                </c:if>

                <td>
                    <button class="btn btn-default" data-toggle="modal" data-target="#myModal1" onclick="editUser(${list.emp_no })"
                            style="float: right;margin: 5px;">编辑
                    </button>
                    <button class="btn btn-danger" onclick="deleteUser(${list.emp_no })" style="float: right;margin: 5px;">删除</button>
                </td>
