...
<div id="center">
    <form action="${pageContext.request.contextPath}/searchEmployeeServlet" method="post">
        <input type="text" id="keywords" placeholder="search" style="border-radius: 5px;height: 30px;" name="keywords">
...
<div id="ww">
    ...
    <div style="width:380px;margin:0 auto;margin-top:50px;">
        <ul class="pagination" style="text-align:center; margin-top:10px;">
            ...
            <c:if test="${pageBean.currPage!=1 }">
                <li><a href="${pageContext.request.contextPath }/findAllEmployeeServlet?currPage=1">首页</a></li>
                <li ><a href="${pageContext.request.contextPath }/findAllEmployeeServlet?currPage=${pageBean.currPage-1 }" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
                </li>
            </c:if>
            ...
            <c:forEach begin="${pageBean.currPage-5>0?pageBean.currPage-5:1 }" end="${pageBean.currPage+4>pageBean.totalPage?pageBean.totalPage:pageBean.currPage+4 }" var="n">
                ...
                <c:if test="${pageBean.currPage!=n }">
                    <li><a href="${pageContext.request.contextPath }/findAllEmployeeServlet?currPage=${n }">${n }</a></li>
                </c:if>
            </c:forEach>
            ...
            <c:if test="${pageBean.currPage!=pageBean.totalPage }">
                <li >
                    <a href="${pageContext.request.contextPath }/findAllEmployeeServlet?currPage=${pageBean.currPage+1 }" aria-label="Next">
                        <span aria-hidden="true">&raquo;</span>
                    </a>
                </li>
                <li><a href="${pageContext.request.contextPath }/findAllEmployeeServlet?currPage=${pageBean.totalPage }">末页</a></li>
            </c:if>
        </ul>
    </div>
    <!-- 分页结束=======================        -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label><input type="text" class="form-control" id="name"
                                              required="required"  name="emp_no"></label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label><input type="text" class="form-control" id="age"
                                              required="required"  name="emp_tel_num"></label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label><input type="text" class="form-control" id="tel"
                                              required="required"  name="emp_addr"></label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label><input type="text" class="form-control" id="emil"
                                              required="required"  name="emp_email"></label>
