...
<head>
    ...
    <script src="${pageContext.request.contextPath}/view/system_manager/js/jquery-2.1.3.min.js"></script>
    ...
    <div id="login">
        ...
        <form action="${pageContext.request.contextPath}/LoginServlet" method="post">
            ...
            <div class="form-group">
                <p align="center">帐名</p>
                <input type="text" class="form-control" id="name" name = "name" placeholder="请输入账号"  onblur="checkUser(this)" >
            </div>
            <div class="form-group">
                <p align="center">密码</p>
...
<script type="text/javascript">
    function checkUser(obj) {
        $.ajax({
            type:"get",
            url:"${pageContext.request.contextPath }/checkUserServlet",
